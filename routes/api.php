...
route::post('reset-password', [AuthenticationController::class, 'action_reset_password']);

route::middleware(['apiToken'])->group(function() {
    route::post('exercise/add', [ExerciseController::class, 'exercise_add']);
    route::post('exercise/upload', [ExerciseController::class, 'exercise_upload']);
    ...
    route::get('workouts/exercises/remove/{id}', [WorkoutExerciseController::class, 'remove']);
});